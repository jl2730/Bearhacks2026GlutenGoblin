...
function Group() {
  return (
    <div className="absolute contents left-[calc(62.5%+14.38px)] top-[789px]">
      ...
      <p className="-translate-x-1/2 absolute font-['Irish_Grover:Regular',sans-serif] h-[18px] leading-[normal] left-[calc(62.5%+74.38px)] not-italic text-[15px] text-center text-white top-[793px] tracking-[0.9px] w-[120px]">scan product</p>
    </div>
  );
}

export default function ScanningBarcode() {
  return (
    <div className="bg-[#385c37] relative size-full" data-name="scanningBarcode">
      ...
      <div className="-translate-x-1/2 absolute font-['Irish_Grover:Regular',sans-serif] h-[73px] leading-[0] left-[198.5px] not-italic text-[0px] text-center text-white top-[651px] tracking-[1.2px] w-[349px]">
        <p className="leading-[normal] mb-0 text-[20px]">Scanning barcode...</p>
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[27px] leading-[normal] left-[20px] not-italic text-[16px] text-white top-[179px] tracking-[0.96px] w-[353px]">Point your camera at a barcode to check your food.</p>
      <Group />
    </div>
  );
}