...
function Results() {
  return (
    <div className="absolute contents left-[20px] top-[517px]" data-name="results">
      <div className="absolute bg-[#8d1915] h-[84px] left-[20px] rounded-[27px] top-[517px] w-[353px]" />
      <div className="-translate-x-1/2 absolute font-['Irish_Grover:Regular',sans-serif] h-[47px] leading-[0] left-[calc(12.5%+147.38px)] not-italic text-[0px] text-center text-white top-[538px] tracking-[1.2px] w-[299px]">
        <p className="leading-[normal] mb-0 text-[20px]">Allergen(s) found!</p>
        <p className="leading-[normal] mb-0 text-[16px]">This is not safe for your goblin</p>
...
function Group() {
  return (
    <div className="absolute contents left-[calc(12.5%-2.13px)] top-[716px]">
      <div className="absolute bg-[#8d1915] h-[48.374px] left-[calc(12.5%-2.13px)] rounded-[11px] top-[716px] w-[299px]" />
      <div className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold h-[29.392px] leading-[0] left-[calc(12.5%+147.38px)] not-italic text-[12px] text-center text-white top-[725.8px] w-[253.261px] whitespace-pre-wrap">
        <p className="leading-[normal] mb-0">{`Gluten detected — don’t eat this. `}</p>
        <p className="leading-[normal]">Try finding a safer alternative.</p>
      </div>
    </div>
  );
}
...
export default function ScannedFailed() {
  return (
    <div className="bg-[#385c37] relative size-full" data-name="ScannedFailed">
      ...
      <div className="absolute h-[406px] left-[20px] rounded-[34px] top-[192px] w-[353px]" data-name="cameraScreen">
        <video autoPlay className="absolute max-w-none object-cover rounded-[34px] size-full" controlsList="nodownload" loop playsInline>
          <source src="/_videos/v1/7596efe3fa864d8db81a86ae1c93736c7c3fff39" />
        </video>
      </div>
      <Results />
