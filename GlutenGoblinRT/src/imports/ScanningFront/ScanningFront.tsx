...
export default function ScanningFront() {
  return (
    <div className="bg-[#385c37] relative size-full" data-name="scanningFront">
      ...
      <div className="-translate-x-1/2 absolute font-['Irish_Grover:Regular',sans-serif] h-[73px] leading-[0] left-[198.5px] not-italic text-[0px] text-center text-white top-[651px] tracking-[1.2px] w-[349px]">
        <p className="leading-[normal] mb-0 text-[20px]">Scanning front...</p>
      ...
      <p className="-translate-x-1/2 absolute font-['Poppins:Regular',sans-serif] h-[27px] leading-[normal] left-[196.5px] not-italic text-[16px] text-center text-white top-[200px] tracking-[0.96px] w-[353px]">{`Scan the front package of the product `}</p>
    </div>
  );
}